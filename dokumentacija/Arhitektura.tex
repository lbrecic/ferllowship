		...
		\section{Baza podataka}
			...
			\subsection{Opis tablica}
				...
				\begin{longtabu} to \textwidth {|X[7, l]|X[7, l]|X[20, l]|}
					...
					\cellcolor{LightGreen}player\_id & UUID 	&  	jedinstveni brojčani identifikator korisnika 	\\ \hline
				...
				\begin{longtabu} to \textwidth {|X[7, l]|X[7, l]|X[20, l]|}
					...
					\cellcolor{LightGreen}token\_id & UUID 	&   jedinstveni brojčani identifikator registracije 	\\ \hline
					token & VARCHAR(255) & token potvrde o registraciji\\ \hline
					\cellcolor{LightBlue}player\_id & UUID 	&   jedinstveni brojčani identifikator korisnika 	\\ \hline  
				...
				\begin{longtabu} to \textwidth {|X[7, l]|X[7, l]|X[20, l]|}
					...
					\cellcolor{LightBlue}username & VARCHAR(32) 	&   korisničko ime igrača 	\\ \hline 
				...
				\begin{longtabu} to \textwidth {|X[7, l]|X[7, l]|X[20, l]|}
					...
					\cellcolor{LightGreen}player\_id & UUID 	&  	jedinstveni brojčani identifikator kartografa 	\\ \hline
				...
				\begin{longtabu} to \textwidth {|X[7, l]|X[7, l]|X[20, l]|}
					...
					\cellcolor{LightGreen}player\_id & UUID 	&  	jedinstveni brojčani identifikator administratora 	\\ \hline
					iban & VARCHAR(34)  & IBAN računa za uplatu plaće \\ \hline 
					id\_photo & VARCHAR(200) & fotografija osobne iskaznice \\ \hline  
				...
				\begin{longtabu} to \textwidth {|X[6, l]|X[7, l]|X[20, l]|}
					...
					\cellcolor{LightGreen}fight\_id & UUID	&  	jedinstveni brojčani identifikator borbe 	\\ \hline
					start & TIMESTAMP  &   trenutak početka borbe \\ \hline 
					duration & INTERVAL	&  	trajanje borbe	\\ \hline 
					\cellcolor{LightBlue}winner	& VARCHAR(32) & korisničko ime pobjednika borbe  	\\ \hline 
					\cellcolor{LightBlue}loser	& VARCHAR(32) & korisničko ime gubitnika borbe  	\\ \hline 
				...
				\begin{longtabu} to \textwidth {|X[6, l]|X[7, l]|X[20, l]|}
					...
					\cellcolor{LightGreen}location\_id & UUID	&   jedinstveni brojčani identifikator lokacije	\\ \hline
					...
					\cellcolor{LightBlue} category\_id	& UUID &   jedinstveni brojčani identifikator kategorije	\\ \hline 
				...
				\begin{longtabu} to \textwidth {|X[6, l]|X[7, l]|X[20, l]|}
					...
					\cellcolor{LightBlue} location\_id	& UUID &   jedinstveni brojčani identifikator lokacije	\\ \hline 
				...
				\begin{longtabu} to \textwidth {|X[6, l]|X[7, l]|X[20, l]|}
					...
					\cellcolor{LightGreen}category\_id & UUID	&   jedinstveni brojčani identifikator kategorije	\\ \hline
				...
				\begin{longtabu} to \textwidth {|X[6, l]|X[6, l]|X[20, l]|}
					...
					\cellcolor{LightGreen}card\_id & UUID	&   jedinstveni brojčani identifikator karte	\\ \hline 
