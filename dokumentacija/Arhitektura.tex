...
%	\end{itemize}
		...
		\section{Baza podataka}
			...
			\subsection{Opis tablica}
				...
				\noindent\textbf{player} $($Igrač$)$ - Ovaj entitet sadržava podatke o korisniku. Svaki korisnik je ujedno i igrač. Sadrži atribute: korisničko ime, lozinku, e-mail adresu, fotografiju i bodove igrača. Ovaj entitet je u \textit{One-to-Many} vezi s entitetom card preko atributa player\_id. Ima dvije \textit{One-to-Many} veze s entitetom fight, koje se odnose na borbe u kojima je igrač pobijedio i borbe u kojima je izgubio. Player je u \textit{One-to-One} vezi s entitetom ban i s entitetom confirmation. Atribut username je alternativni ključ entiteta.
				...
				\noindent\textbf{ban} $($Zabrana pristupa$)$ - Ovaj entitet sadržava podatke o igračima kojima je zabranjen pristup aplikaciji. Sadrži atribute kraj zabrane i korisničko ime igrača. Ovaj entitet u vezi je \textit{One-to-One} s korisnikom (player$)$ preko ID-a korisnika.
				...
				\begin{longtabu} to \textwidth {|X[7, l]|X[6, l]|X[20, l]|}
					...
					\cellcolor{LightBlue}\textit{player\_id} & UUID 	&   korisničko ime igrača 	\\ \hline 
