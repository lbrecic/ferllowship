		...
		\section{Baza podataka}
			...
			\subsection{Opis tablica}
				...
				\begin{longtabu} to \textwidth {|X[7, l]|X[6, l]|X[20, l]|}
					...
					\cellcolor{LightGreen}username & VARCHAR	&  	jedinstveni identifikator korisnika 	\\ \hline
				...
				\begin{longtabu} to \textwidth {|X[7, l]|X[6, l]|X[20, l]|}
					...
					photo & UUID & fotografija (avatar$)$ korisnika \\ \hline 
					points & INT	&  	broj bodova igrača	\\ \hline 
					iban & VARCHAR & IBAN računa za uplatu plaće \\ \hline 
				...
				\begin{longtabu} to \textwidth {|X[6, l]|X[6, l]|X[20, l]|}
					...
					\cellcolor{LightBlue}winner	& VARCHAR & korisničko ime pobjednika borbe  	\\ \hline 
					\cellcolor{LightBlue}loser	& VARCHAR & korisničko ime gubitnika borbe  	\\ \hline 
